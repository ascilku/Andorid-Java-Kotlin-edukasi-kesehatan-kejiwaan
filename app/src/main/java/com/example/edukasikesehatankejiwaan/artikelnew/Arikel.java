...
public class Arikel extends AppCompatActivity {

    private List<ModelArtikel> model_lap_sayas = new ArrayList<>();
    ProgressBar progresHome1;
    RecyclerView rv_laporan_saya;
    private RecyclerArtikel laporan_adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.arikel);
...
//            Toast.makeText(getApplicationContext(), "sd", Toast.LENGTH_SHORT).show();
        ...
        laporan_adapter = new RecyclerArtikel(this,model_lap_sayas);
    ...
    void jadwalSidang(){
        ...
        Call<Value> call = mApiInterface.getUser();
        call.enqueue(new Callback<Value>() {
            ...
            public void onResponse(Call<Value> call, Response<Value> response) {
                ...
                if (value.equals("1")){
                    ...
                    laporan_adapter = new RecyclerArtikel(getApplicationContext(), model_lap_sayas);
                    rv_laporan_saya.setAdapter(laporan_adapter);
                }else{
